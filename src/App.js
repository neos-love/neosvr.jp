...
const capMaterial = new THREE.MeshStandardMaterial({ metalness: 0.75, roughness: 0.15, color: "#F5A60f", emissive: "#000000", envMapIntensity: 20 })
  ...
  return (
    <RigidBody linearDamping={0.75} angularDamping={0.15} friction={0.2} position={[r(20), r(20) - 25, r(20) - 10]} ref={api} colliders={false} dispose={null}>
      ...
      <MeshCollider type="hull">
        <mesh castShadow scale={1.5 * scale} position={[0, 0, 0]} geometry={nodes.円.geometry} material={capMaterial} />
      </MeshCollider>
    </RigidBody>
  )
}
